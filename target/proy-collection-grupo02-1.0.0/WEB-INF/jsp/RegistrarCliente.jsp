		 						...
		 						<strong class="logo "> 	
		 							<a href="index-2.html"> 
		 								<img src="img/logo.png" 
		 									alt="Sistema de Colleciones de Figuritas" title="Sistema de Colleciones de Figuritas" /> 									
		 							</a> 								
		 						</strong> 
		 					</div> 							
		 					<!-- /logo --> 
					...
					<div class="container"> 
						...
						<!-- main menu --> 	
							<ul class="main-menu menu visible-lg">
 								<li class="active"> 
 									<a href="index-2.html"><i class="icon-home"></i></a>
				...
				<div class="main-content">
					<div class="container">
						<div class="row">
							...
							<div class="section">
							  <p>If you already have an account with us, please login at the <a href="Login.htm">login page</a>.</p>
							  <form:form method="post" action="addCliente.htm">
							 <h2>Datos Personales</h2>
								<div class="content">
								  <table class="form">
									<tbody>
									<tr>
									  <td><span class="required">*</span> First Name:<form:errors path="firstname"/></td>
									  <td><form:input path="firstname"  name="firstname" value=""/></td>
									</tr>
									<tr>
									  <td><span class="required">*</span> Last Name:<form:errors path="lastname"/></td>
									  <td><form:input path="lastname"  name="lastname" value=""/></td>
									</tr>
									<tr>
									  <td><span class="required">*</span> E-Mail:<form:errors path="email"/></td>
									  <td><form:input path="email"  name="email" value=""/></td>
									</tr>
									<tr>
									  <td><span class="required">*</span> Telephone:<form:errors path="telephone"/></td>
									  <td><form:input path="telephone"  name="telephone" value=""/></td>
									</tr>
									<tr>
									  <td><span class="required">*</span> DNI:<form:errors path="dni"/></td>
									  <td><form:input path="dni" name="dni" value=""/>
										</td>
									</tr>							
									<tr>
									  <td><span class="required">*</span>User<form:errors path="dni"/></td>
									  <td><form:input path="user"  name="password" value=""/>
										</td>
									</tr>
									<tr>
									  <td><span class="required">*</span> Password:<form:errors path="password"/></td>
									  <td><form:password path="password"  name="password" value=""/>
										</td>
									</tr>
									<tr>
									  <td><span class="required">*</span> Password Confirm:<form:errors path="password2"/></td>
									  <td><form:password path="password2"  name="confirm" value=""/>
										</td>
									</tr>
								  </tbody></table>
								</div>
