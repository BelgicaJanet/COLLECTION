			...
			<div id="site-wrapper">
				...
				<div id="top-slider" class="flexslider-container container">
					<div class="flexslider">
						...
						<ul class="slides">
							<li>
								<img src="http://ninetheme.com/themes/commercahtml/img/placeholder/slider3.jpg" alt="" />

							</li>
							<li>
								<img src="http://ninetheme.com/themes/commercahtml/img/placeholder/slider4.jpg" alt="" />
							</li>
							<li><img src="http://ninetheme.com/themes/commercahtml/img/placeholder/slider3.jpg" alt="" /></li>
							<li><img src="http://ninetheme.com/themes/commercahtml/img/placeholder/slider5.jpg" alt="" /></li>
							<li><img src="http://ninetheme.com/themes/commercahtml/img/placeholder/slider4.jpg" alt="" /></li>
						</ul>
						<!-- #END SLIDES -->
				...
				<div class="section carousel-iframe">
					<div class="container">
						...
						<h4 class="section-title">Latest Discounts</h4>
											...
											<li>
												<div class="product">
													<a href="#" class="product-link clearfix">
														<div class="ribbon specials">SALE</div>
														<div class="product-thumbnail">
															<img src="img/placeholder/bannerm1.jpg" alt="banner" />
															
														</div>
														<div class="product-info clearfix">
															<h3 class="title">Summer Products</h3>
														</div>
													</a>
												</div>
											</li>
											<li>
												<div class="product">
													<a href="#" class="product-link clearfix">
														<div class="ribbon specials">SALE</div>
														<div class="product-thumbnail">
															<img src="img/placeholder/bannerm2.jpg" alt="banner" />
											...
											<li>
												<div class="product">
													<a href="#" class="product-link clearfix">
														<div class="ribbon specials">SALE</div>
														<div class="product-thumbnail">
															<img src="img/placeholder/bannerm3.jpg" alt="banner" />
												...
												<div class="product">
													<a href="#" class="product-link clearfix">
														<div class="ribbon specials">SALE</div>
														<div class="product-thumbnail">
															<img src="img/placeholder/bannerm4.jpg" alt="banner" />
...
<!-- Mirrored from ninetheme.com/themes/commercahtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 May 2015 23:36:34 GMT -->
</html>
=======
<!DOCTYPE html>
<html>
